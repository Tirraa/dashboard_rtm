...
function getRetrievedValuesFromArgs(args: string[]): MaybeIncorrectTFlagsAssoc {
  ...
  const indexOfDefaultI18nLocaleFile = args.indexOf(FLAGS.I18N_LOCALES_SCHEMA_FILEPATH);
  ...
  const I18N_LOCALES_SCHEMA_FILEPATH = indexOfDefaultI18nLocaleFile !== -1 ? args[indexOfDefaultI18nLocaleFile + 1] : undefined;
 ...
 * @throws {ArgumentsValidatorError}
 */
function checkIfFilesExist({ BLOG_CONFIG_FILEPATH, I18N_LOCALES_SCHEMA_FILEPATH, POSTS_FOLDER }: TFlagsAssoc) {
