...
### The [blog.ts config file](/src/config/Blog/server.ts)

**If you use automated imports (i.e.: `Object.fromEntries` in the [blog.ts config file](/src/config/Blog/server.ts)), you're already done!**  
