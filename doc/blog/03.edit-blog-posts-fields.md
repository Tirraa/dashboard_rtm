...
Let's adapt the `_DOCUMENTS_COMPUTED_FIELDS` variable in the [_ContentLayerConfigTweakers.ts_ file](/interop/types/ContentLayerConfigTweakers.ts):
...
And then, let's adapt the `DOCUMENTS_FIELDS` variable:
