...
```bash
# package.json
static-analyzer start -- --posts-folder ./posts --blog-config-file ./src/config/blog.ts --i18n-skeleton-locale ./src/i18n/locales/skeleton.ts --skip-locales-infos # * ... Added --skip-locales-infos
```
