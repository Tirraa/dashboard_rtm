...
export const SitewideNavbar: FunctionComponent<SitewideNavbarProps> = () => {
  ...
  return (
    <nav className="max-w-screen min-w-screen sticky inset-x-0 top-0 z-30 flex h-auto w-screen items-center justify-center bg-black backdrop-blur-lg backdrop-saturate-150 dark:bg-card">
