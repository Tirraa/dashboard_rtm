...
export const NavbarHamburgerMenuButtonStyle: IButtonStyleBase = {
...
export const NAVBAR_HAMBURGER_MENU_BUTTON_COMPONENTS_PROPS = {
  animate: {
    mount: { y: 0 },
...
export const NAVBAR_HAMBURGER_MENU_INNER_BUTTONS_CLASSLIST = 'flex items-center h-full px-4 py-2.5';

export default NavbarHamburgerMenuButtonStyle;
