...
export const PrimitiveComponents: Record<string, (...args: any[]) => JSX.Element> = {
  ...
  h3: ({ className, ...props }) => <h3 className={cn('mt-8 scroll-m-20 text-2xl font-semibold tracking-tight', className)} {...props} />,
  h4: ({ className, ...props }) => <h4 className={cn('mt-8 scroll-m-20 text-xl font-semibold tracking-tight', className)} {...props} />,
  h5: ({ className, ...props }) => <h5 className={cn('mt-8 scroll-m-20 text-lg font-semibold tracking-tight', className)} {...props} />,
  h6: ({ className, ...props }) => <h6 className={cn('mt-8 scroll-m-20 text-base font-semibold tracking-tight', className)} {...props} />,
  ...
  pre: ({ className, ...props }) => <pre className={cn('mb-4 mt-6 overflow-x-auto rounded-lg bg-black py-4 px-4', className)} {...props} />,
  code: ({ className, ...props }) => <code {...{ ...props, className }} />
};
